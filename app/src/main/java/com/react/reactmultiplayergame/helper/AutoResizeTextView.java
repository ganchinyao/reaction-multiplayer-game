...
/**
 * Created by gan on 3/5/17.
 *
 * Better than the grantland version one, as this one accounts for height
 * How to use: in xml tag, use com.mypackage.AutoResizeTextView
 */
